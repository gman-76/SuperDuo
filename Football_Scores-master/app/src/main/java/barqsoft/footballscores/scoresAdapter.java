...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        String scoreText = Utilies.getScores(cursor.getInt(COL_HOME_GOALS), cursor.getInt(COL_AWAY_GOALS));

        view.setContentDescription(cursor.getString(COL_HOME) + " vs " + cursor.getString(COL_AWAY) + ". Score " + scoreText);
